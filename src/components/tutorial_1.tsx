        ...
        <tr>
          ...
          <td>
            <input
              ...
              value={_entry.sample}
              onChange={(_e: any) => this.changeTdList2(_e, _index)}
            />
          </td>
          <td>
            <Button bsStyle="success" onClick={() => this.putData1(_index)}>
              更新
            </Button>
          </td>
        </tr>
        ...
        if (_response.data) {
          ...
          this.isPutData1Messeage = (
            <span>
              ...
              <br />
              <br />
              更新前の対象データのid: {data.feed.entry[0].id}
            </span>
          )
      ...
      (_response: AxiosResponse) => {
        if (_isError) {
          this.isGetPutData1Messeage = (
            <div>
              ↓<br />
              更新対象データのidは<b>{_response.data.feed.entry[0].id}</b>です。
              <br />
              リビジョン番号が一致していないため競合エラーとなり更新できませんでした。
            </div>
          )
        } else {
          this.isGetPutData1Messeage = (
            <div>
              ↓<br />
              更新後の対象データのid：<b>{_response.data.feed.entry[0].id}</b>
            </div>
          )
        }
        this.forceUpdate()
        ...
        <tr>
          ...
          <td>
            <input
              ...
              className="form-control"
              value={_entry.sample}
              onChange={(_e: React.FormEvent<HTMLInputElement>) => this.changeTdList3(_e, _index)}
            />
          </td>
          <td>
            <Button bsStyle="success" onClick={() => this.putData2(_index)}>
              更新
            </Button>
          </td>
          <td>
            <Button bsStyle="danger" onClick={() => this.deleteData1(_index)}>
              削除
            </Button>
          </td>
        </tr>
          ...
          <div className="vtecx-demo">
            ...
            <div className="vtecx-demo-container">
              <div className="vtecx-demo-content">
                <h1>チュートリアル：基礎編</h1>
                <p>
                  ここではvte.cxのアプリケーション作成に必要な基礎的な知識をチュートリアル形式で説明いたします。実際にデータを入力し登録・更新・削除を行い、どのように動作しているのかを手順を確認します。
                </p>
              </div>
            </div>
            <div className="vtecx-demo-container">
              <div className="vtecx-demo-content">
                ...
                <div className="block">
                  <div>
                    まずは以下のメッセージを確認してください。
                    <br />
                    <code>{this.authError}</code>
                    <br />
                    <b>
                      {'{"'}feed{'"'}: {'{"'}title{'"'}:{'"'}Access denied.{'"}}'}
                    </b>{' '}
                    」 もしくは「{' '}
                    <b>
                      {'{"'}feed{'"'}: {'{"'}title{'"'}:{'"'}Authentication error.{'"}}'}
                    </b>{' '}
                    」と表示されている場合、 この後の手順を実行するためにはログイン認証が必要です。
                    <a href="login.html" target="_blank" rel="noreferrer noopener">
                      ログイン画面
                    </a>
                    に移動し、サービスを作成したアカウントでログインを実行してください。
                    <br />
                ...
                <div className="block">
                  ...
                  <div className="supplement">
                    ...
                    {this.uid !== '' && (
                      <span>
                        （あなたのユーザ識別子は <b>{this.uid}</b> となります。）
                      </span>
                    )}
                    <br />
                    ...
                    <br />
                    <code>
                      /_user/{this.uid !== '' ? this.uid : '{UID}'}
                      <br />
                      /_user/{this.uid !== '' ? this.uid : '{UID}'}/accesskey
                      <br />
                      /_user/{this.uid !== '' ? this.uid : '{UID}'}/auth
                      <br />
                      /_user/{this.uid !== '' ? this.uid : '{UID}'}/group
                    </code>
                    <p className="comment">
                      ※ UIDは「サービス専用管理画面 {'>'} ユーザ管理 」からでも確認できます。
                    </p>
                  </div>
                  <br />
            ...
            <div className="vtecx-demo-container">
              <div className="vtecx-demo-content">
                ...
                <div className="block">
                  ...
                  <hr />
                  {this.isPostData1 && (
                    <Alert bsStyle={this.isPostData1}>{this.isPostData1Messeage}</Alert>
                  )}
                  <br />
                  <br />
                  {/*{"feed":{"title":"Entry is required."}}*/}
                  <b>
                    {'{"'}feed{'"'}: {'{"'}title{'"'}:{'"'}JSON parse error: sample is not defined
                    in the schema template.{'"}}'}
                  </b>{' '}
                  」と表示されませんでしたか？
                  <br />
                  ...
                  <code>{JSON.stringify(this.postData1Obj)}</code>
                  ...
                  <br />
                  <div>
                    エントリ項目の登録は「 <b>サービス専用管理画面 {'>'} エントリスキーマ管理</b>{' '}
                    」から行えます。
                  </div>
                  <ul>
                    <li>サービス専用管理画面を開くには以下のリンクをクリックしてください。</li>
                    <li>
                      <a href={this.adminUrl} target="_blank" rel="noreferrer noopener">
                        {this.adminUrl}
                      </a>
                      <br />
                      <br />
                      <p className="comment">サービス専用管理画面を開くにはログインが必要です。</p>
                      <p className="comment">
                        上記リンクで開けない場合は、
                        <a href="https://admin.vte.cx/" target="_blank" rel="noreferrer noopener">
                          {'https://admin.vte.cx'}
            ...
            <div className="vtecx-demo-container">
              <div className="vtecx-demo-content">
                ...
                <div className="block">
                  ...
                  <hr />
                  {this.isPostData2 && (
                    <Alert bsStyle={this.isPostData2}>{this.isPostData2Messeage}</Alert>
                  )}
                  <ul>
                    <li>
                      <p>データが登録されている様子 例）</p>
            ...
            <div className="vtecx-demo-container">
              <div className="vtecx-demo-content">
                ...
                <div className="block">
                  ...
                  <hr />
                  {this.isPostData3 && (
                    <Alert bsStyle={this.isPostData3}>{this.isPostData3Messeage}</Alert>
                  )}
                  <br />
                  <br />「{' '}
                  <b>
                    {'{"'}feed{'"'}: {'{"'}title{'"'}:{'"'}Parent path is required. /sample_list
                    {'"}}'}
                  </b>{' '}
                  」と表示されませんでしたか？
                  <br />
                  ...
                  <br />
                  <div>
                    エンドポイントの登録は「 <b>サービス専用管理画面 {'>'} エンドポイント管理</b>{' '}
                    」から行えます。
                  </div>
                  <ul>
                    <li>サービス専用管理画面を開くには以下のリンクをクリックしてください。</li>
            ...
            <div className="vtecx-demo-container">
              <div className="vtecx-demo-content">
                ...
                <div className="block">
                  ...
                  <hr />
                  {this.isPostData4 && (
                    <Alert bsStyle={this.isPostData4}>{this.isPostData4Messeage}</Alert>
                  )}
                  <ul>
                    <li>
                      <p>データが登録されている様子 例）</p>
            ...
            <div className="vtecx-demo-container">
              <div className="vtecx-demo-content">
                ...
                <div className="block">
                  ...
                  <ul>
                    <li>
                      取得URLに「 <b>?f</b> 」パラメータを追加することで「{' '}
                      <b>/d/sample_list配下のデータを取得する</b> 」ことができます。
                    </li>
                    <li>
                      このテーブルは以下のようなロジックで作成されています。（_response.dataの中に通信結果が格納されています。）
                      <img src="https://admin.vte.cx/img/demo_7.png" />
                    </li>
                    <li>
                      feed項目配下のentry項目が配列になっているため、entry項目を繰り返しループすることで1行づつentry情報を参照することができます。
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="vtecx-demo-container">
              <div className="vtecx-demo-content">
                ...
                <div className="block">
                  ...
                  <hr />
                  {this.isGetData2 && (
                    <Alert bsStyle={this.isGetData2}>{this.isGetData2Messeage}</Alert>
                  )}
                  {this.getList2Tabel()}
                  {this.isPutData1 && (
                  ...
                  <ul>
                    <li>
                      更新に成功した場合、idの「,(カンマ)」の後ろの数字がカウントアップしていることがわかります。
                      <br />
                      このカウントアップした値を「<b>リビジョン番号</b>」と呼びます。
                      <br />
                      <code>
                        idの構成: {'{ 更新データのURL }'},{'{ リビジョン番号 }'}
                        <br />
                        <br />
                        例） /sample_list/5700305828184064,1
                      </code>
                      リクエストデータとサービスのデータストアのデータのリビジョン番号を照合し、
                      <b>一致していない場合エラーとなります。</b>
                    </li>
                    <li>
                      では、どのようなエラーが発生するのか確認してみましょう。
                      <br />
                      もう一度続けて先程更新したデータと同じデータの「更新」ボタンを押下してみてください。
                    </li>
                    <li>
                      「{' '}
                      <b>
                        {'{"'}feed{'"'}: {'{"'}title{'"'}:{'"'}Optimistic locking failed. Key ={' '}
                        {'{ 更新データのURL }'}
                        {'"}}'}
                      </b>{' '}
                      」と表示されませんでしたか？
                    ...
                    <li>
                      競合が発生した場合は、
                      <b>
                        リクエストデータのリビジョン番号とサービスのデータストアのリビジョン番号を合わせなければなりません。
                      </b>
                      <br />
                      上記「取得」ボタンを押下するとサービスのデータストアと同期するため、また更新ができるようになります。
                    </li>
                    <li>
                      アプリを作成する場合は、クライアントサイドは「{' '}
                      <b>更新に成功したらリビジョン番号をカウントアップする</b>{' '}
                      」ということを忘れないでください。
                    </li>
                  </ul>
                </div>
            ...
            <div className="vtecx-demo-container">
              <div className="vtecx-demo-content">
                ...
                <div className="block">
                  ...
                  <hr />
                  {this.isGetData3 && (
                    <Alert bsStyle={this.isGetData3}>{this.isGetData3Messeage}</Alert>
                  )}
                  {this.getList3Tabel()}
                  {this.isPutData2 && (
                  ...
                  {this.isDeleteData1 && (
                    <Alert bsStyle={this.isDeleteData1}>{this.isDeleteData1Messeage}</Alert>
                  )}
                  <ul>
                    <li>
                      削除に成功したメッセージが表示された場合、「取得」ボタンを押下してください。
                      <br />
                    ...
                    <li>
                      削除は以下のリクエストを実行しています。
                      <code>
                        DELETE {'{ 削除データのURL }'}?r={'{ 削除データのリビジョン番号 }'}
                        <br />
                        <br />
                    ...
                    <li>
                      削除にも更新時と同じように「<b>リビジョン番号</b>」を使用します。
                      <br />
                      リクエストデータとサービスのデータストアのデータのリビジョン番号を照合し、
                      <b>一致していない場合エラーとなります。</b>
                    </li>
