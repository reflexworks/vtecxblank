...
import {getDeliverycharge,getChargeByZone,getPrefecture,getFullDate,getKey } from './put-billing'
...
function getBillingData(entry) {
	...
	const billing_data = {
		...
		'link': [
			{ '___rel': 'self' , '___href': '/billing_data/' + getKey(delivery_charge_all.customer_code,entry.billing.shipping_date, delivery_charge_all.shipment_service_code,entry.billing.tracking_number) }
		]
	}
