...
import {shipment_class,customer_code,shipment_service_code,getChargeByZone,getDeliverycharge,getFullDate,getKey,getChargeOfMail } from './put-billing'
...
function getBillingDataOfHatsu(entry,shipment_service_service_name) {
	...
	const charge_by_zone = getChargeByZone( customer_all,entry.billing.size, entry.billing.prefecture, entry.billing.shipper_code,shipment_service_service_name)
